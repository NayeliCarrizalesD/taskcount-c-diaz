        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-200 bg-neutral-950 table-auto min-w-max">
          ...
          <tbody>
            {clientes.map((cliente, index) => (
              <tr key={cliente.id_cliente} className={index % 2 ? "bg-zinc-900 text-sm hover:bg-sky-900 hover:text-white border-b border-neutral-400" : "text-sm  hover:bg-sky-900 hover:text-white border-b border-neutral-400"}>
